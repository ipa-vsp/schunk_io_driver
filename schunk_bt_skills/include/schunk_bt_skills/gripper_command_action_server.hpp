...
{
    class GripperCommandActionServer : public ros2_skill_server_core::SkillActionServerLifecycleCore<
        schunk_command_interface::action::GripperCommand>
    {
        public:
            using ActionT = schunk_command_interface::action::GripperCommand;
            explicit GripperCommandActionServer(const std::string action_name, const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
